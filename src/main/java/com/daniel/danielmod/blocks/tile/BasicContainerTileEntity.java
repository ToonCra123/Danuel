package com.daniel.danielmod.blocks.tile;
...
public class BasicContainerTileEntity extends TileEntity implements INamedContainerProvider {
    public static final int NUMBER_OF_SLOTS = 9;

    public BasicContainerTileEntity() {
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("container.danielmod.basic_container");
    }
    ...
    public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return BasicContainer.createContainerServerSide(windowID, playerInventory, chestContents);
    }
