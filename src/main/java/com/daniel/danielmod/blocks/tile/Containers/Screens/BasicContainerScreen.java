package com.daniel.danielmod.blocks.tile.Containers.Screens;

import com.daniel.danielmod.DanielMod;
import com.daniel.danielmod.blocks.BasicContainerBlock;
 ...
 *
 */
public class BasicContainerScreen extends ContainerScreen<BasicContainer> {

    public BasicContainerScreen(BasicContainer containerBasic, PlayerInventory playerInventory, ITextComponent title) {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        final float CHEST_LABEL_YPOS = BasicContainer.TILE_INVENTORY_YPOS - FONT_Y_SPACING;
        this.font.func_243248_b(matrixStack, this.title,
                LABEL_XPOS, CHEST_LABEL_YPOS, Color.darkGray.getRGB());  //this.font.drawString;

        final float PLAYER_INV_LABEL_YPOS = BasicContainer.PLAYER_INVENTORY_YPOS - FONT_Y_SPACING;
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(DanielMod.mod_id, "textures/gui/basic_container_inventory.png");
}