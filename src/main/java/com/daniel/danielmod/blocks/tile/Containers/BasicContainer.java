package com.daniel.danielmod.blocks.tile.Containers;

import com.daniel.danielmod.blocks.StartUpCommon;
import com.daniel.danielmod.blocks.tile.BasicContainerTileEntity;
import com.daniel.danielmod.blocks.tile.TileUtils.ChestContents;
...
public class BasicContainer extends Container {
    public static BasicContainer createContainerServerSide(int windowID, PlayerInventory playerInventory, ChestContents chestContents) {
        return new BasicContainer(windowID, playerInventory, chestContents);
    }

    public static BasicContainer createContainerClientSide(int windowID, PlayerInventory playerInventory, net.minecraft.network.PacketBuffer extraData) {
        ...
        ChestContents chestContents = ChestContents.createForClientSideContainer(BasicContainerTileEntity.NUMBER_OF_SLOTS);
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = BasicContainerTileEntity.NUMBER_OF_SLOTS;  // must match TileEntityInventoryBasic.NUMBER_OF_SLOTS
     ...
     */
    private BasicContainer(int windowID, PlayerInventory playerInventory, ChestContents chestContents) {
